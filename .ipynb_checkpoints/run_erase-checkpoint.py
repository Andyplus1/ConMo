...
from utilities.guidance_utils_multimasks_interfere_try_erase import (
    get_timesteps,
    register_time,
    register_guidance,
    calculate_losses,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_path", type=str, default="/root/autodl-tmp/DMT-to-MTASAP_4ablation/configs/guidance_config_up_withmultimasks_interfere_try_erase.yaml")
